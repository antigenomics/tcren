"""Deprecated location; moved to :mod:`tcren.energetics.rotamers` on 2026-09-01.

Re-exported so every existing import keeps working. See :mod:`tcren.energetics` for why the module now
lives where it does.
"""
from __future__ import annotations

from .energetics import rotamers as _moved
