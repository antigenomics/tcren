"""Deprecated location; moved to :mod:`tcren.mechanics.stability` on 2026-09-01.

Re-exported so every existing import keeps working. See :mod:`tcren.mechanics` for why the module now
lives where it does.
"""
from __future__ import annotations

from .mechanics import stability as _moved
